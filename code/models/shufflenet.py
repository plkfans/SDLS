...
def shufflenet_v2_x0_5(pretrained=False, num_classes=1000):
    """
    ...
    if pretrained:
        model.load_state_dict(model_zoo.load_url(model_urls['shufflenet_v2_x0_5']), strict=False)
    return model


def shufflenet_v2_x1_0(pretrained=False, num_classes=1000):
    """
    ...
    model = ShuffleNetV2(stages_repeats=[4, 8, 4],
                         ...
                         num_classes=num_classes)
    if pretrained:
        model.load_state_dict(model_zoo.load_url(model_urls['shufflenet_v2_x1_0']), strict=False)
    return model


def shufflenet_v2_x1_5(pretrained=False, num_classes=1000):
    """
    Constructs a ShuffleNetV2 with 1.0x output channels, as described in
    `"ShuffleNet V2: Practical Guidelines for Efficient CNN Architecture Design"
    <https://arxiv.org/abs/1807.11164>`.
    ...
    model = ShuffleNetV2(stages_repeats=[4, 8, 4],
                         ...
                         num_classes=num_classes)
    if pretrained:
        model.load_state_dict(model_zoo.load_url(model_urls['shufflenet_v2_x1_5']), strict=False)
    return model


def shufflenet_v2_x2_0(pretrained=False, num_classes=1000):
    """
    Constructs a ShuffleNetV2 with 1.0x output channels, as described in
    `"ShuffleNet V2: Practical Guidelines for Efficient CNN Architecture Design"
    <https://arxiv.org/abs/1807.11164>`.
    ...
    model = ShuffleNetV2(stages_repeats=[4, 8, 4],
                         ...
                         num_classes=num_classes)
    if pretrained:
        model.load_state_dict(model_zoo.load_url(model_urls['shufflenet_v2_x2_0']), strict=False)
    return model
